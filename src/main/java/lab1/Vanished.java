...
public class Vanished {
    ...
    public LastSeeingPlace getLastSeeingPlace() {
        return lastSeeingPlace;
    }

    public void setLastSeeingPlace(LastSeeingPlace lastSeeingPlace) {
    ...
    public static class Builder {
         ...
         * @return returns current object
         */
        public Builder setLastSeeingPlace(LastSeeingPlace lastSeeingPlace) {
